rem @echo off
setlocal
path C:\texlive\2020\tlpkg\tlperl\bin;C:\texlive\2020\bin\win32;%path%
set PERL5LIB=C:\texlive\2020\tlpkg\tlperl\lib
...
perl.exe "C:\texlive\2020\texmf-dist\scripts\texlive\uninstall-win32.pl" %1

if errorlevel 1 goto :eof
rem test for taskkill and try to stop exit tray menu
taskkill /? >nul 2>&1
if not errorlevel 1 1>nul 2>&1 taskkill /IM tl-tray-menu.exe /f
copy "C:\texlive\2020\tlpkg\installer\uninst2.bat" "%TEMP%"
rem pause
"%TEMP%\uninst2.bat"
